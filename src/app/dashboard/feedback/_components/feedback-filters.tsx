...
export function FeedbackFilters({ branches }: FeedbackFiltersProps) {
  ...
  return (
    <FilterBarShell activeCount={activeFilterCount} onClearAll={urlHasFilters ? clearFilters : undefined} description={undefined}>
      <div className="flex flex-wrap items-center gap-2.5">
        <div className="relative flex-1 min-w-[180px] flex items-center">
          ...
          <Button 
            variant="primary" 
            size="sm" 
            className="absolute right-1.5 top-1/2 -translate-y-1/2 h-8 px-3 text-micro"
        ...
        <SelectInput
          ...
          className="h-10 !min-h-0 !py-0 text-caption min-w-[120px]"
        ...
        <div className="flex items-center gap-1.5">
          <TextInput
            ...
            className="h-10 !min-h-0 !py-0 text-caption w-[130px]"
          />
