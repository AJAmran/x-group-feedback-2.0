// app/loading.tsx — shown automatically by Next.js App Router while page.tsx
// is streaming (e.g., while fetchActiveBranches() resolves server-side).
// This replaces the inline Suspense fallback in page.tsx.
